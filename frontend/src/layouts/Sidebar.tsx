    ...
    <aside className="hidden w-64 shrink-0 border-r border-slate-200 bg-white lg:flex lg:flex-col">
      ...
      <nav className="flex-1 space-y-1 px-3 py-6">
        ...
        <div className="pt-8">
          ...
          <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-400">
            <BarChart3 size={18} />
            <span>Analytics</span>
      ...
      <div className="border-t border-slate-200 p-3">
        <NavLink
          to="/dashboard"
          className="mb-2 flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-50"
        >
          <Settings size={18} />
          Settings
        </NavLink>
